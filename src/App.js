...
const App = (props) => {
    ...
    return (
        <React.Fragment>
            ...
            {/* For some reason the Google OAuth env variable does not work? */}
            <meta
                name="google-signin-client_id"
                content={
                    '678540909389-rn0oidtibsjklbdbd2ken7l1ri3c4rgr.apps.googleusercontent.com'
                }
            />
                    ...
                    <div className="col-sm">
                        ...
                        >
                            <div class="card-body" style={{ marginTop: '2em' }}>
                                ...
                                >
                                    mihaisebastian01@gmail.com /
                                    mihaisebastian2507@gmail.com
                                </h5>
                                <p
                                    class="card-text"
                                    style={{ marginTop: '2em' }}
                                >
                                    Frontend interface for the Node backend
                                    Case, which will provide a cool UX for
                                    querying films, aggregating both IMDb and
                                    YouTube public APIs.
                                </p>
                                <p
                                    class="card-text"
                                ...
                                >
                                    I am no Graphic Designer, but I tried my
                                    best to make a pleasant looking User
                                    Interface! If I had more time, I would have
                                    done this in Tailwind instead of Boostrap,
                                    but deadlines have to be respected!
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        >
                            <div>
                                ...
                                <form>
                                    ...
                                    >
                                        {' '}
                                        (GDPR) By proceeeding using this
                                        application I accept by default that the
                                        developer is not responsible for any
                                        GDPR, data leakage or user data related
                                        problems that might occur in the
                                        process, as the project is not meant for
                                        public use, but solely for evaluation
                                        purposes! (See Backend and Project
                                        Manual for details){' '}
                                    </label>
                                </form>
                                {consent == true &&
                                (localStorage.getItem('isLoggedIn') ==
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                Log me in! (Only use
                                                Chrome/Firefox // See below for
                                                error 400)
                                            </h2>
                                            <p style={{ float: 'right' }}>
                                                {' '}
                                                If the Google OAuth2 yields a
                                                '400' error, refresh the page
                                                and try again (Strange error
                                                that occurs upon account
                                                creation)
                                            </p>{' '}
                                        </GoogleLogin>
                                    </div>
                                ...
                                (localStorage.getItem('isLoggedIn') ==
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                Accept the condition to proceed
